...
public class MamHierarchyApiApplication implements CommandLineRunner {

	@Autowired
	private MediaHierarchyRepository repository;
	
	public static void main(String[] args) {
		
		SpringApplication.run(MamHierarchyApiApplication.class, args);
	}
